...
urlpatterns = [
    ...
    path("finance/recurring/", v.finance_recurring_page, name="finance_recurring"),
    path("finance/exchange-rates/", v.finance_exchange_rates_page, name="finance_exchange_rates"),

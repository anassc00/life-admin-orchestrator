---
name: commit-pro
description: Professional git commit assistant that follows Conventional Commits specification. Asks which project to commit, stages changes, analyzes them, and proposes a well-formatted commit message for review before executing.
---
...
- Invokes this skill manually

## Process

### Step1 — Ask for the project path
...
### Step5 — Present proposal and ask for confirmation
